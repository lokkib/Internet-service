...
const SignIn = () => {
    return <div className={styles.signInWrapper}>
        ...
        <InputAuth classType='password' placeholder='Пароль' id='formpassword' name='password' type='password' />
        <ButtonSearchSave classType="signIn"
        text="Войти" />
        <ButtonSearchSave classType="signUp"
